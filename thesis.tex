...
\include{src/cel-i-zakres-pracy.tex}

\include{src/cyfrowa-reprezentacja-dźwięku.tex}
\include{src/technologia-CUDA.tex}

\include{src/projekt-systemu.tex}
\include{src/implementacja-CPU.tex}
\include{src/wybrane-algorytmy-przetwarzania-generowania-dźwięku.tex}
\include{src/implementacja-GPU.tex}

\include{src/projekt-i-wyniki-testow.tex}

\include{src/wnioski.tex}
\include{src/możliwości-rozwoju.tex}
