...
\begin{itemize}
    \item \cite{bib:performance-1} - \citetitle{bib:performance-1}
    \item \cite{bib:performance-2} - \citetitle{bib:performance-2}
    \item \cite{bib:performance-3} - \citetitle{bib:performance-3}
    \item \cite{bib:performance-4} - \citetitle{bib:performance-4}
    \item \cite{bib:performance-5} - \citetitle{bib:performance-5}
    \item \cite{bib:performance-6} - \citetitle{bib:performance-6}
\end{itemize}
